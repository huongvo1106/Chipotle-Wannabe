...
9-25-2019
 */
public class jdbcpostgreSQLGUI4
{
      ...
      try
      {
        while (cont == true)  // continue ordering more items
        {
          ...
          if (item_type == 0)  // order entree
          {
            ...
            int e_choice = JOptionPane.showOptionDialog(f, "Select entree: \n We recommend: "+rec.recToCustomer("E", prior, conn), "Menu", JOptionPane.DEFAULT_OPTION,
